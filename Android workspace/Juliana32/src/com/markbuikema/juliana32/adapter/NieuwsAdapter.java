...
public class NieuwsAdapter extends ArrayAdapter<NieuwsItem> {
			...
			animatedView.setOnHoverListener( new OnHoverListener() {
				...
				public boolean onHover( View arg0, MotionEvent arg1 ) {
					...
					case MotionEvent.ACTION_HOVER_ENTER:
						animatedView.setBackgroundColor( getContext().getResources().getColor( R.color.focused ) );
						break;
	...
	public static View constructFacebookPhotoView( Context context, FacebookNieuwsItem fbPhotoItem, View convertView ) {
		...
		final ImageView singlePhotoView = (ImageView) convertView.findViewById( R.id.facebookSinglePhoto );
		...
		if ( ! singlePhoto ) {
			...
			UrlImageViewHelper.setUrlDrawable( singlePhotoView, Util.PHOTO_URL_PREFIX + fbPhotoItem.getDefaultPhoto()
		...
		TextView fbSubTitle = (TextView) convertView.findViewById( R.id.nieuwsitem_subtitle );
