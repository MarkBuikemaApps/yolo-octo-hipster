...
public class DefaultHeaderTransformer extends PullToRefreshAttacher.HeaderTransformer {
	...
	public void onViewCreated(Activity activity, View headerView) {
		...
		mHeaderTextView.setBackgroundResource(com.markbuikema.juliana32.R.color.grey);
	...
	/**
	 * Set color to apply to the progress bar. Automatically enables usage of the
	 * custom color. Use {@link #setProgressBarColorEnabled(boolean)} to disable
	 * and re-enable the custom color usage.
	 * <p/>
	 ...
	 * color to use with {@link #setProgressBarColor(int)}, which also
